  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">Laravel blog</a></h4>
        @auth
    ...
    @if (session()->has('success'))
      <div class="container container--narrow notification-message">
